...
_syncformer_ckpt_path = "weights/synchformer_state_dict.pth"
...
def extract(args):
    ...
    with open(video_path, 'r', encoding='utf-8') as f:
        video_paths = [Path(line.strip().split("\t")[0]) for line in f]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--video_path', type=str, required=True, help='video path file')

...
# ORIG_PATH = Path("/ailab-train/speech/liangyunming/20250212/VideoLLaMA2/av-benchmark-main/tttest_vggsound")  # Path to the folder with videos to reencode
raw_file = "test.scp"
dst_dir = "/ailab-train/speech/liangyunming/20250212/dataset/vggtest_video_norm"
...
def reencode_video(path):
    ...
    nname = path.split("/")[-1]
    new_path = f"{dst_dir}/{nname}"
    # print("111111111111111: ", new_path)
...
def main():
    ...
    with open(raw_file, "r", encoding='utf-8') as f:
        video_paths = [(line.strip().split("\t")[0]) for line in f.readlines()]
